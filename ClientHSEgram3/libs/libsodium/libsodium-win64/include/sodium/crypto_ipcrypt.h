...
void crypto_ipcrypt_nd_encrypt(
    ...
    const unsigned char k[crypto_ipcrypt_ND_KEYBYTES]) __attribute__((nonnull));

SODIUM_EXPORT
void crypto_ipcrypt_nd_decrypt(
    unsigned char out[crypto_ipcrypt_ND_INPUTBYTES],
...
void crypto_ipcrypt_ndx_decrypt(
    unsigned char out[crypto_ipcrypt_NDX_INPUTBYTES],
